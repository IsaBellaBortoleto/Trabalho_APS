...
class HotDogFrango(HotDog):
    ...
    def getpreco(self): #retorno o preço na variável resultado
        ...
        cursor.execute("SELECT preco FROM hotdog WHERE id = 3")
    ...
    def getnome(self):
        ...
        cursor.execute("SELECT nome from hotdog WHERE id = 3")
        resultado = cursor.fetchone()
    ...
    def getingredientes(self):
        ...
        cursor.execute(f"SELECT {colunas} FROM hotdog WHERE id = 3")
    ...
    def getimagem(self):
        ...
        cursor.execute("SELECT imagem FROM hotdog WHERE id = 3")
        resultado = cursor.fetchone()
    ...
    def alteraritem(self, coluna, novovalor): #altera a coluna pra novovalor
        ...
        atualizacao = f"UPDATE hotdog SET {coluna} = %s WHERE id = 3"
