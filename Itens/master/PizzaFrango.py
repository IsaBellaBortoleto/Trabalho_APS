...
class PizzaFrango(Pizza):
    ...
    def getpreco(self): #retorno o preço na variável resultado
        ...
        cursor.execute("SELECT preco FROM pizza WHERE id = 3")
    ...
    def getingredientes(self):
        ...
        cursor.execute(f"SELECT {colunas} FROM pizza WHERE id = 3")
    ...
    def getimagem(self):
        ...
        cursor.execute("SELECT imagem FROM pizza WHERE id = 3")
        resultado = cursor.fetchone()
    ...
    def alteraritem(self, coluna, novovalor): #altera a coluna pra novovalor
        ...
        atualizacao = f"UPDATE pizza SET {coluna} = %s WHERE id = 3"
