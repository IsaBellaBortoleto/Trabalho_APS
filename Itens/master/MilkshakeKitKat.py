...
class MilshakeKitKat(Milkshake):
    #construtora
    def __init__(self): 
        pass
    ...
    def getpreco(self): #retorno o preço na variável resultado
        ...
        cursor.execute("SELECT preco FROM milkshake WHERE id = 3")
    ...
    def getnome(self):
        ...
        cursor.execute("SELECT nome from milkshake WHERE id = 3")
        resultado = cursor.fetchone()
    ...
    def getingredientes(self):
        ...
        cursor.execute(f"SELECT {colunas} FROM milkshake WHERE id = 3")
    ...
    def getimagem(self):
        ...
        cursor.execute("SELECT imagem FROM milkshake WHERE id = 3")
        resultado = cursor.fetchone()
    ...
    def alteraritem(self, coluna, novovalor): #altera a coluna pra novovalor
        ...
        atualizacao = f"UPDATE milkshake SET {coluna} = %s WHERE id = 3"
