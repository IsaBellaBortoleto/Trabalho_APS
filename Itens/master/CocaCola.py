...
class CocaCola(Bebida):
    ...
    def getpreco(self): #retorno o preço na variável resultado
        ...
        cursor.execute("SELECT preco FROM bebida WHERE id = 1")
    ...
    def getnome(self):
        ...
        cursor.execute("SELECT nome from bebida WHERE id = 1")
        resultado = cursor.fetchone()
    ...
    def getimagem(self):
        ...
        cursor.execute("SELECT imagem FROM bebida WHERE id = 1")
        resultado = cursor.fetchone()
    ...
    def getcapacidade(self):
        ...
        cursor.execute("SELECT capacidade from bebida WHERE id = 1")
        resultado = cursor.fetchone()
    ...
    def alteraritem(self, coluna, novovalor): #altera a coluna pra novovalor
        ...
        atualizacao = f"UPDATE bebida SET {coluna} = %s WHERE id = 1"
